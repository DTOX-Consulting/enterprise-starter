...
const AlertDialogTrigger = forwardRef<HTMLButtonElement, ComponentPropsWithoutRef<typeof Trigger>>(
...
const AlertDialogOverlay = forwardRef<HTMLDivElement, ComponentPropsWithoutRef<typeof Overlay>>(
  ({ className, ...props }, ref) => (
    <Overlay
      className={cn(
...
const AlertDialogContent = forwardRef<HTMLDivElement, ComponentPropsWithoutRef<typeof Content>>(
  ({ className, ...props }, ref) => (
    <Portal>
      <Overlay />
...
const AlertDialogTitle = forwardRef<HTMLHeadingElement, ComponentPropsWithoutRef<typeof Title>>(
  ({ className, ...props }, ref) => (
...
const AlertDialogAction = forwardRef<HTMLButtonElement, ComponentPropsWithoutRef<typeof Action>>(
  ({ className, ...props }, ref) => (
...
const AlertDialogCancel = forwardRef<HTMLButtonElement, ComponentPropsWithoutRef<typeof Cancel>>(
  ({ className, ...props }, ref) => (
    <Cancel
      ref={ref}
