...
import type { OrganizationBusiness } from '@/lib/db/rxdb/schemas/organization_business';
import type { CollectionSchema, CommonProperties } from '@/lib/db/rxdb/utils/schema';
import type { RxCollection } from 'rxdb';

export type { History, Business, Notification, Organization, OrganizationBusiness };
...
export type OrganizationBusinessSchema = CollectionSchema<OrganizationBusiness>;
...
export type OrganizationBusinessCollection = RxCollection<OrganizationBusinessSchema>;
...
export type PreviousDataOrganizationBusiness = PreviousData<OrganizationBusiness>;
