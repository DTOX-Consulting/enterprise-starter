...
const MissionStatementDefinition = `
**Definition:**
...
const MissionStatementMistakes = `
...
const MissionStatementExamples = `
...
const MissionStatementInstructions = `
When crafting your mission statement, focus on the following:

**Mission Statement**:
  - Describe the fundamental purpose and activities of the organization.
  - Clearly articulate what the organization does, who it serves, and how it serves them.
  - Ensure clarity and precision in conveying the mission, guiding day-to-day operations and decision-making.

1. **Clarity**: Clearly define the fundamental purpose and activities of the organization.
2. **Conciseness**: Keep the statement concise and focused on key information.
3. **Inspiration**: Use engaging language and storytelling to inspire stakeholders.
4. **Alignment**: Ensure the mission statement aligns with the organization's core values and objectives.
5. **Differentiation**: Highlight what sets the organization apart and makes it unique.
6. **Human Connection**: Connect the mission statement to the human experience, making it relatable and compelling.
7. **Avoid Jargon**: Use plain language and avoid buzzwords to ensure accessibility and clarity.
8. **Aspiration**: Communicate the organization's aspirations and goals for the future.
9. **Action-Oriented**: Define what the organization does, who it serves, and how it serves them.
10. **Relevance**: Ensure the mission statement is relevant to the organization's industry and target market.

Return in format:
- Provide an ordered list (using numbers) of 3 mission statements on separate lines.
`.trim();

export const MissionStatement = `
${MissionStatementPersona}

${MissionStatementDefinition}

${MissionStatementMistakes}

${MissionStatementExamples}

${MissionStatementInstructions}
`.trim();
