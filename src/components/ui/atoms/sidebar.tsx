...
>(
  (
    ...
    const toggleSidebar = useCallback(
      () =>
        isMobile ? setOpenMobile((isOpenMobile) => !isOpenMobile) : setOpen((isOpen) => !isOpen),
      [isMobile, setOpen]
    );
...
const SidebarInput = forwardRef<HTMLInputElement, ComponentProps<typeof Input>>(
  ({ className, ...props }, ref) => (
    <Input
      ref={ref}
      data-sidebar="input"
...
const SidebarSeparator = forwardRef<HTMLDivElement, ComponentProps<typeof Separator>>(
  ({ className, ...props }, ref) => (
    <Separator
      ref={ref}
