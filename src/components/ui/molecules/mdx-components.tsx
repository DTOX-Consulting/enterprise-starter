...
import type { ImgHTMLAttributes, HTMLAttributes, PropsWithChildren } from 'react';

const components: MDXComponents = {
  h1: ({ className, ...props }: PropsWithChildren<React.HTMLAttributes<HTMLHeadingElement>>) => (
    <h1 className={cn('mt-2 scroll-m-20 text-4xl font-bold', className)} {...props} />
  ),
  h2: ({ className, ...props }: PropsWithChildren<React.HTMLAttributes<HTMLHeadingElement>>) => (
    <h2
      className={cn(
  ...
  h3: ({ className, ...props }: PropsWithChildren<React.HTMLAttributes<HTMLHeadingElement>>) => (
    <h3
      className={cn('mt-8 scroll-m-20 text-2xl font-semibold tracking-tight', className)}
      {...props}
    />
  ),
  h4: ({ className, ...props }: PropsWithChildren<React.HTMLAttributes<HTMLHeadingElement>>) => (
    <h4
      className={cn('mt-8 scroll-m-20 text-xl font-semibold tracking-tight', className)}
      {...props}
    />
  ),
  h5: ({ className, ...props }: PropsWithChildren<React.HTMLAttributes<HTMLHeadingElement>>) => (
    <h5
      className={cn('mt-8 scroll-m-20 text-lg font-semibold tracking-tight', className)}
      {...props}
    />
  ),
  h6: ({ className, ...props }: PropsWithChildren<React.HTMLAttributes<HTMLHeadingElement>>) => (
    <h6
  ...
  p: ({ className, ...props }: PropsWithChildren<React.HTMLAttributes<HTMLParagraphElement>>) => (
  ...
  tr: ({ className, ...props }: PropsWithChildren<React.HTMLAttributes<HTMLTableRowElement>>) => (
  ...
  pre: ({ className, ...props }: PropsWithChildren<React.HTMLAttributes<HTMLPreElement>>) => (
    <pre
      className={cn('mb-4 mt-6 overflow-x-auto rounded-lg border bg-black py-4', className)}
      {...props}
    />
  ),
  code: ({ className, ...props }: PropsWithChildren<React.HTMLAttributes<HTMLElement>>) => (
    <code
