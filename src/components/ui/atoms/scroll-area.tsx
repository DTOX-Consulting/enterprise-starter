...
const ScrollArea = forwardRef<HTMLDivElement, ComponentPropsWithoutRef<typeof ScrollAreaRoot>>(
...
const ScrollBar = forwardRef<HTMLDivElement, ComponentPropsWithoutRef<typeof ScrollAreaScrollbar>>(
