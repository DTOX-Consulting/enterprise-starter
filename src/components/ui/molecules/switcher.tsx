      ...
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          ...
          >
            ...
            <ChevronsUpDown className="ml-1 size-4 text-gray-11 dark:text-graydark-11" />
          </Button>
        </PopoverTrigger>
...
function SwitcherWrapper({ children, icon }: PropsWithChildren<{ icon?: LucideIcon }>) {
  const Icon = icon;
  return (
    <div className="flex h-10 flex-row items-center truncate rounded-lg px-3 text-gray-11 dark:text-graydark-11">
      <span className="text-md flex items-center justify-center text-gray-4 dark:text-graydark-11">
