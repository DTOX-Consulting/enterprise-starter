...
function getLinkClassNames(
  ...
  return cn(
    'flex h-16 flex-row items-center whitespace-nowrap rounded-r-md border-l-2 border-transparent px-3 text-gray-11 hover:bg-gray-100 hover:text-gray-11 dark:text-graydark-11 dark:hover:text-gray-11',
    className,
    {
      'h-10': item.bottom,
      'rounded-full border-2': isMinimized,
      'mx-0 h-10': navigationProps.isSubLink,
      'bg-gray-100 text-gray-11 dark:text-gray-11': navigationProps.isActive(item),
